...
#define WIFI_SSID "FiOS-WR4SP"
#define WIFI_PASSWORD "fit2272ads953inane"
#define FIREBASE_HOST "covidcareattempt4-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "rur3IRqWEppdix0pPl5t3YyiAOGZdxr51iAtEAG9"
...
void loop() {
  ...
  if (rfid.uid.uidByte[0] != nuidPICC[0] || 
    ...
    Firebase.setBool("user/antarapal235/inStore", true);
  ...
  Firebase.setBool("user/antarapal235/inStore", false);
